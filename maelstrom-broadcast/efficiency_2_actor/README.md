...
```sh
maelstrom test -w broadcast --bin target.tmp/release/efficiency_2_actor --node-count 25 --time-limit 20 --rate 100 --latency 100 

maelstrom test -w broadcast --bin target.tmp/release/efficiency_2_actor --node-count 25 --time-limit 20 --rate 100 --latency 100 --nemesis partition
